      ...
      <Container className='nav-container'>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto d-flex gap-2 my-3 align-items-center w-100">
            ...
            <Link className='w-100 text-white text-decoration-none btn border-white  mx-auto my-1' to='/Login'>Login</Link>
            <Link style={{"fontSize": "15px"}} className='w-100 text-purple text-decoration-none btn bg-white ' to='/IndividualBusiness'>SignUp</Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
